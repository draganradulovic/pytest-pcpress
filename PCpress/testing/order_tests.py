...
class Order_tests(unittest.TestCase):
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\test_positive_order_data.csv"))
    @unpack
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\test_invalid_quantity_data.csv"))
    @unpack
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\test_invalid_drpd_select_data.csv"))
    @unpack
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\test_invalid_name_field_data.csv"))
    @unpack
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\test_invalid_address_field_data.csv"))
    @unpack
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\test_invalid_phone_field_data.csv"))
    @unpack
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\test_invalid_email_field_data.csv"))
    @unpack
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\test_empty_ordering_form_data.csv"))
    @unpack
    ...
    @data(*get_csv_data(r"C:\Users\User\PycharmProjects\PCpress\utilities\verify_zip_city_sync_data.csv"))
    @unpack
